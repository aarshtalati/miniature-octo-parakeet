...
$(document).ready(function () {
  var fv = $("#msform").validate({
    ...
    messages: {
      ...
      /* step 4 validations */
      tbStudentWhatsappNumber: {
        pattern: phone_regex_message,
      },
      tbStudentEmail: {
        pattern: email_regex_message,
      },
      tbStudnetCardNumber: {
...
$(document).on("click", "button#add_more_parent_contact", function () {
  ...
  $(
    "#ddStudentParentContactType_" + parent_count + "_" + parent_con_count
  ).rules("add", {
    required: true,
    messages: { required: "Contact Type is required" },
  });
  $(
    "#ddStudentParentContactValue_" + parent_count + "_" + parent_con_count
  ).rules("add", {
    required: true,
    messages: { required: "Contact Value is required" },
  });
...
$(document).on("click", "button#add_more_parent", function () {
  ...
  $("#ddStudentParentContactType_" + parent_count + "_0").rules("add", {
    required: true,
    messages: { required: "Contact Type is required" },
  });
...
function prepareJson() {
  ...
  $("#student_parent_info")
    ...
    .each(function () {
      ...
      $(this)
        .find("#student_parent_contact_info")
        .find(".contact-row")
        .each(function () {
